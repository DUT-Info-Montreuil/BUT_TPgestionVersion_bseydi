...
public class QuestLine {
    ...
    public QuestLine(Joueur j){
        ...
        quetes.add(new TalkQuete("Chapitre 1 - C'est parti pour le jeu", "Si vous voulez jouer, jouez.\n Si vous arrivez au bout, c'est bien !\n Serez vous de taille ?", 5, "Commit", 1, "vendeur"));
        quetes.add(new TalkQuete("Chapitre 1 - C'est parti pour le jeu", "'Salut à toi héros ici tu trouveras tout ce qu'il te faut, va voir le forgeron pour acheter des armes ou traiter tes minerais'\nAller parler au forgeron au sud de la ville.", 5, "Miel", 1, "upgrader"));
        quetes.add(new LootQuete("Chapitre 1 - C'est parti pour le jeu", "'Si tu veux acheter du nouveau matos c'est ici que ça se passe ! Tiens d'ailleurs, rend moi un service tu veux.'\nMiner une source de minerai à l'est.", 10, "Fer", 1, "SourceMinerai", 1));
        quetes.add(new TalkQuete("Chapitre 1 - C'est parti pour le jeu", "'Il faudrait peut-etre que je me renseigne à propos de ce livre, une fois que j'aurai amener la marchandise biensur'\nAmener les minerais au forgeron.", 40, "Fer", 3, "upgrader"));
